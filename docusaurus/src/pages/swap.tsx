...
export default function Swap() {
  return (
    <Layout title="Hello" description="Hello React Page">
      ...
      <div className="app">
        <div
          style={{"padding":"env(safe-area-inset-top, 0px) env(safe-area-inset-right, 0px) env(safe-area-inset-bottom, 0px)\n              env(safe-area-inset-left, 0px)","position":"relative","display":"grid","gridTemplate":"'d d d' auto\n              'a a a' auto\n              'b c c' 1fr\n              'b c c' 1fr / auto 1fr 1fr","overflow":"hidden","willChange":"opacity"}}
        ...
        >
              ...
              <div className="Row flex gap-8 items-center">
                <div>
                  <div className="PopoverButton">
                    <div
                      className="Icon grid h-[max-content] w-[max-content] text-[#ABC4FF] opacity-60 hover:opacity-75 clickable clickable-filter-effect clickable-mask-offset-3"
                    >
                      <svg
                ...
                <div>
                  <div className="PopoverButton">
                    <button
                      className="Button px-4 py-2.5 rounded-xl mobile:rounded-lg whitespace-nowrap appearance-none inline-block font-medium bg-formkit-thumb text-formkit-thumb-text-normal clickable clickable-filter-effect frosted-glass frosted-glass-teal"
                    >
          ...
          <div
            className="Col flex flex-col h-full overflow-y-auto w-56 mobile:w-48 mobile:rounded-tr-2xl mobile:rounded-br-2xl flex-container grid-area-b"
          >
            <div className="Col flex-col grid grid-rows-[2fr,1fr,auto] flex-1 overflow-hidden">
              <div className="shrink overflow-y-auto min-h-[120px] py-4 space-y-1 mobile:py-0 px-2 mr-2 mobile:ml-2 mb-2">
                <a
                  ...
                  ><div className="Row flex items-center">
                    <div
                      className="grid bg-gradient-to-br from-[rgba(57,208,216,0.2)] to-[rgba(57,208,216,0)] rounded-lg p-1.5 mr-3"
                    >
                      <div className="Icon grid h-[max-content] w-[max-content]">
                    ...
                    <div
                      className="Row flex grow items-center justify-between text-[#ACE3E5] text-sm mobile:text-xs font-medium"
                    >
                      <div>Trading</div>
                ...
                ><span
                  ...
                  ><div className="Row flex items-center">
                    ...
                    <div
                      className="Row flex grow items-center justify-between text-[rgba(57,208,216,1)] text-sm mobile:text-xs font-medium"
                    >
                      <div>Swap</div>
                    </div>
                  </div></span
                ...
                ><a
                  ...
                  ><div className="Row flex items-center">
                    ...
                    >
                      <div className="Icon grid h-[max-content] w-[max-content]">
                        <img src="/icons/entry-icon-acceleraytor.svg" alt="entry-icon-acceleray" className="h-4 w-4" />
                      </div>
                    </div>
                    <div
                      className="Row flex grow items-center justify-between text-[#ACE3E5] text-sm mobile:text-xs font-medium"
              ...
              <div className="Col flex flex-col mobile:h-[180px] overflow-scroll no-native-scrollbar">
                ...
                <div className="flex-1 overflow-auto no-native-scrollbar mt-2">
                  <div>
                    <div className="PopoverButton">
                      <div
                        className="block py-4 mobile:py-3 px-8 pl-6 mobile:px-5 hover:bg-[rgba(57,208,216,0.1)] active:bg-[rgba(41,157,163,0.3)] cursor-pointer group"
                      >
                    ...
                    <div className="PopoverButton">
                      <span
                        ...
                        ><div className="Row flex items-center w-full mobile:justify-center">
                          ...
                          <span className="text-[#ACE3E5] text-sm mobile:text-xs font-medium flex-grow">Settings</span>
                          <div className="Icon grid h-[max-content] w-[max-content]">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                    ...
                    <div className="PopoverButton">
                      <span
                        ...
                        ><div className="Row flex items-center w-full mobile:justify-center">
                          ...
                          <span className="text-[#ACE3E5] text-sm mobile:text-xs font-medium flex-grow">Community</span>
                          <div className="Icon grid h-[max-content] w-[max-content]">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                  ...
                  <a
                    ...
                    ><div className="Row flex items-center w-full mobile:justify-center">
                      ...
                      <span
                        className="text-[#ACE3E5] text-sm mobile:text-xs font-medium flex-grow group-hover:text-[rgba(57,208,216,1)]"
                        >Docs</span
                      >
                    </div></a
                  ><a
              ...
              <div
                className="text-sm m-2 opacity-20 hover:opacity-100 transition font-medium text-[#abc4ff] whitespace-nowrap"
              >
              </div>
            </div>
          </div>
          ...
          >
            <div className="Row flex justify-center mb-12 mobile:mb-2">
              <div
                ...
                style={{"background":"linear-gradient(140.14deg, rgba(0, 182, 191, 0.15) 0%, rgba(27, 22, 89, 0.1) 86.61%), linear-gradient(321.82deg, #18134d 0%, #1b1659 100%)"}}
              ...
              >
                ...
                >
                  <div
                    ...
                    style={
                        {"background":"linear-gradient(245.22deg, rgb(218, 46, 239), rgb(43, 106, 255), rgb(57, 208, 216))","backgroundSize":"400% 100%","backgroundPosition":"0%"}
                    }
                  >
                    Swap
                  </div>
            ...
            <div
              ...
              style={
                {"borderRadius":"21px","padding":"1px","backgroundImage":"linear-gradient(246deg, #da2eef 7.97%, #2b6aff 49.17%, #39d0d8 92.1%)"}
              }
            >
              <div
                className="Card rounded-3xl py-8 pt-4 px-6 mobile:py-5 mobile:px-3"
                style={
                    {"background":"linear-gradient(140.14deg, rgba(0, 182, 191, 0.15) 0%, rgba(27, 22, 89, 0.1) 86.61%),\n                    linear-gradient(321.82deg, #18134d 0%, #1b1659 100%)"}
                }
              >
                <div className="space-y-5 mt-5">
                  <div className="Row flex flex-col bg-[#141041] cursor-text rounded-xl py-3 px-6 mobile:px-4" tabIndex={0}>
                    <div className="Row flex justify-between mb-2 mobile:mb-4">
                      ...
                      <div
                        className="text-xs mobile:text-2xs justify-self-end text-[rgba(171,196,255,.5)] clickable no-clicable-transform-effect clickable-filter-effect"
                      >
                    ...
                    <div className="Row flex col-span-full items-center">
                      <div className="Row flex items-center gap-1.5 clickable clickable-mask-offset-2">
                        <div
                          className="text-[rgb(171,196,255)] font-medium text-base flex-grow mobile:text-sm whitespace-nowrap"
                        >
                          --
                        </div>
                      ...
                      <div
                        className="my-1 mx-4 mobile:my-0 mobile:mx-2 border-r border-[rgba(171,196,255,0.5)] self-stretch"
                      ></div>
                      <div className="Row flex justify-between flex-grow-2">
                        <div className="Row flex gap-px items-center mr-2">
                          <button
                            className="Button mobile:rounded-lg whitespace-nowrap appearance-none inline-block opacity-50 cursor-not-allowed py-0.5 px-1.5 rounded text-[rgba(171,196,255,.5)] font-bold bg-[#1B1659] bg-opacity-80 text-xs mobile:text-2xs transition"
                          >
                            Max</button
                          ><button
                            className="Button mobile:rounded-lg whitespace-nowrap appearance-none inline-block opacity-50 cursor-not-allowed py-0.5 px-1.5 rounded text-[rgba(171,196,255,.5)] font-bold bg-[#1B1659] bg-opacity-80 text-xs mobile:text-2xs transition"
                        ...
                        <div
                          className="Row flex Input cursor-not-allowed items-center font-medium text-lg text-white flex-grow w-full"
                        >
                    ...
                    <div
                      className="text-xs mobile:text-2xs text-[rgba(171,196,255,.5)] invisible text-ellipsis overflow-hidden text-right"
                    >
                      --
                    </div>
                  </div>
                  <div className="relative h-8">
                    <div className="Row flex absolute items-center transition-all left-1/2 -translate-x-1/2">
                      <div
                        className="Icon grid h-[max-content] w-[max-content] p-2 frosted-glass frosted-glass-teal rounded-full mr-4 clickable select-none transition"
                      >
                          ...
                          <div className="w-full h-full rounded clickable clickable-filter-effect">
                            <svg width="36" height="36" viewBox="0 0 36 36">
                              ...
                              <circle
                                ...
                                style={
                                    {"strokeWidth":"3","stroke":"#92e1ffd9","transform":"rotate(-90deg)","transformOrigin":"center","strokeLinecap":"round","transition":"200ms"}
                                }
                              ></circle>
                            </svg>
                          </div>
                ...
                <button
                  className="Button px-4 py-2.5 rounded-xl mobile:rounded-lg whitespace-nowrap appearance-none inline-block font-medium bg-formkit-thumb text-formkit-thumb-text-normal clickable clickable-filter-effect w-full frosted-glass-teal mt-5"
                >
                  Connect Wallet
                </button>
              </div>
